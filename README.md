...
1. [프로젝트 소개](#-프로젝트-소개)
2. [기능 설명](#-기능-설명)
3. [스수로가 만들어갈 미래](#-스수로가-만들어갈-미래-effectiveness)
4. [플랫폼별 필수 조건 안내](#-플랫폼별-필수-조건-안내-prerequisites)
5. [기술 스택](#-기술-스택-technique-used)
6. [협업 도구](#-협업-도구-collaboration-tools)
7. [설치 안내](#-설치-안내-installation-process)
8. [프로젝트 사용법](#-프로젝트-사용법-getting-started)
9. [팀 정보](#-팀-정보-team-information)
10. [저작권 및 사용권 정보](#-저작권-및-사용권-정보-copyleft--end-user-license)
...
### 2. 발전 가능성
- Team AutoMedic이 제작한 **범용적인 API**를 활용하여 의약품에서 전 보급품으로 영역을 확장할 수 있습니다.
