...
class AppColors {
  // Key
  Color keyRed = const Color(0xFFED8BC0);
  Color keyBlue = const Color(0xFF8BA1ED);
  Color keyGreen = const Color(0xFF6DDB8C);
  Color keyGrey = const Color(0xFF808080);
  ...
  Color bgYellow = const Color(0xFFE8D000);
